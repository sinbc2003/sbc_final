...
### 남은 것 (다음 세션 인수인계)
- [ ] gemma-4 E4B — 야간 학습 진행 중(~250s/step, 익일 새벽 2시경 완주). 완주 시: `convert_lora_to_gguf.py final --base D:\models\hf\gemma-4-E4B-it` → `D:\models\loras\gongmun_g4e4b_v1.gguf` → 배포 GGUF(`D:\models\teacherflow\gemma-4-E4B-it-Q3_K_S.gguf`) 장착 A/B.
